...
class KeyValueStoreClient
{
 ...
 private:
    ...
    virtual void get(ostk::StorageObject& obj, const std::vector<std::string>& keys = {}) const = 0;

    virtual void put(const ostk::StorageObject& obj, const std::vector<std::string>& keys = {}) const = 0;

    virtual void remove(const ostk::StorageObject& obj) const = 0;

    virtual void list(const ostk::Metadata::Query& query, std::vector<ostk::StorageObject>& fetched) const;
};