...
private:
    ...
    void get(ostk::StorageObject& obj, const std::vector<std::string>& keys = {}) const override;

    void put(const ostk::StorageObject& obj, const std::vector<std::string>& keys = {}) const override;
