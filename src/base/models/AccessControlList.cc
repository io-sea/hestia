...
AccessControlList::AccessControlList() : Serializeable("acl") {}

void AccessControlList::deserialize(const Dictionary& dict, Format)
{
...
void AccessControlList::serialize(Dictionary& dict, Format) const
{
