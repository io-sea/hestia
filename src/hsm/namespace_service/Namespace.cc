...
namespace hestia {
Namespace::Namespace() : OwnableModel("namespace") {}

Namespace::Namespace(const std::string& name) : OwnableModel(name, "namespace")
{
}

Namespace::Namespace(const Uuid& id) : OwnableModel(id) {}

void Namespace::deserialize(const Dictionary& dict, SerializeFormat format)
{
