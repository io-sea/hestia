...
if __name__ == "__main__":
    ...
    parser.add_argument('--patch_var', type=str, default="CI_PATCH_RELEASE_VERSION")
    parser.add_argument('--minor_var', type=str, default="CI_MINOR_RELEASE_VERSION")
    parser.add_argument('--major_var', type=str, default="CI_MAJOR_RELEASE_VERSION")
    ...
    api.update_variable(key=args.patch_var, val=f"{major_ver-1}.{minor_ver-1}.{patch_ver}")
